...
status  = 25 (SLP, FRZ), 12 (PSN, BRN, PAR), 0(none)
ballMod = 255(poke), 200(great), 150(ultra)

f = (HPmax * 255 * 4)/(HPcur * Ball)

Ball = 12(poke), 8(great), 6(ultra)
*/
